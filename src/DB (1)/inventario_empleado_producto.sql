...
CREATE TABLE `empleado_producto` (
  `cuiEmpleado` int NOT NULL,
  `cuiProducto` int NOT NULL,
  `fecha_de_modificacion` date NOT NULL,
  `motivo_de_cambio` varchar(255) NOT NULL,
  `fecha_solicitud_pedido` date NOT NULL,
  PRIMARY KEY (`cuiEmpleado`,`cuiProducto`),
  KEY `cuiProducto` (`cuiProducto`),
  CONSTRAINT `empleado_producto_ibfk_1` FOREIGN KEY (`cuiEmpleado`) REFERENCES `empleado` (`cuiEmpleado`),
  CONSTRAINT `empleado_producto_ibfk_2` FOREIGN KEY (`cuiProducto`) REFERENCES `producto` (`cuiProducto`)
...
-- Dump completed on 2024-03-19 22:13:26
